...
function Dashboard(props) {
  ...
  useEffect(() => {
    props.getUserCourseList(props.user.id);
  }, []);
        ...
        <div className="container-fluid">
          <div className="row mt-5">
            ...
            <div className="col-md-10">
              <Paper className={classes.root} square elevation={0} component='div'>
                <Tabs
                  value={value}
                ...
                >
                  ...
                  <Tab
                    label={`My courses(${props.courseLists.length})`}
                    icon={<ListIcon />}
                  />
                </Tabs>
              </Paper>
                ...
                <div className="dashboard-wrapper pt-3 pb-3 rounded border">
                  <div className="container-fluid">
                    <div className="row">
                      ...
                      <div className="col-md-4 text-center">
                        ...
                        >
                          ...
                          {/* Count all Lectures from each courses where course belong to the user */}
                      ...
                      <div className="col-md-4 text-center">
                        ...
                        >
                          ...
                          {/* Count all students from each courses where course belong to the user */}
                          <h3 className="display-5">
                    ...
                    <div className="row mt-5">
                      ...
                      <div className="col-md-6">
                        <div className="year">
                          <select name="year" className=" col-2 form-control">
...
const mapStateToProps = (state /*, ownProps*/) => {
  return {
    ...
    courseLists: state.user.user.courseLists,
    students: state.user.user.students
  };
};
