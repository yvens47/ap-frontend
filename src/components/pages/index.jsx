        ...
        >
          <div className="custom-bg-overla">
            <div className="container-fluid">
              ...
              <div className="row  mb-5 pt-5 pb-3 border-top ">
                <div
                ...
                >
                  <div className="row    pb-3 justify-content-md-center">
                    <div className="col-sm-12 col-md-8">
                      <h2
                        className="display-4 text-center pt-5 border-bottom pb-2   wow bounceInUp"
                        style={{
                          color: "#3f3d56;",
                          fontSize: "100px",
                          fontWeight: "bold"
                ...
                <div
                  className="container pt-5 mt-5  pb-3 border-top rounded-top shadow"
                  style={{
                    background: "rgb(235,246,246)",
                    background:
                      "linear-gradient(176deg, rgb(235 246 246 / 0%) 0%, rgb(233, 241, 240) 65%, rgb(132, 203, 194) 100%)"
                  }}
                >
              ...
              <div
                className="row  pt-5 pb-5  justify-content-md-center"
